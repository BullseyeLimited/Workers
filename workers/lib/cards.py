...
SEGMENT_NAMES: Dict[str, str] = {
    ...
    "61": "SHADOW_SELF_AND_PROJECTION_TARGETS",
    "62": "COGNITIVE_DISTORTIONS_AND_LOGIC_BUGS",
    "63": "SECURITY_TESTING_AND_PUSH_PULL_PATTERNS",
    "64": "EMOTIONAL_CO_REGULATION_DYNAMICS",
    "65": "EPISTEMIC_TRUST_AND_PERSUASION_KEYS",
    "66": "BIOGRAPHICAL_EMOTIONAL_WEIGHTING",
}
